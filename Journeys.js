var config = {
    style: 'mapbox://styles/branigan/cjz37rcb003ib1cr3s8rnkt2d', //mapbox://styles/examples/cj68bstx01a3r2rndlud0pwpv
    accessToken: 'pk.eyJ1IjoibWJ4c29sdXRpb25zIiwiYSI6ImNrMm01aG9hdTBlZGwzbXQ1ZXVrNHNmejAifQ.QHQA0N6XPWddCXtvoODHZg',
    showMarkers: false,
    theme: 'dark',
    use3dTerrain: true,
    title: 'Geo-narrative Visualization Demo: How did the pandemic affect my journeys?',
    ...
    chapters: [
        {
            ...
            title: 'Hi, these are my stories before, during, and after the pandemic. I record it here as a memory of my unforgettable journeys and turning points in my life.',
            //description: '',
            location: {
                center: [0, 0],
                zoom: 0,
        ...
        },
        {
            ...
            image: 'pics/5.png',
            description: 'As soon as we got off the plane, we were taken for COVID testing. There were still two days of transit time, so I decided to go skydiving to Palm Island to fulfill one of my little wishes.',
            location: {
                center: [54.9693, 25.2256],//Dubai
                zoom: 6,
                pitch: 30.00,
                bearing: 0
            },
        ...
        },
        {
            ...
            location: {
                center: [80.5862, 6.8203],//Sri Lanka, Colombo
                zoom: 8,
                pitch: 50.00,
                bearing: 0
            },
        ...
        },
        {
            ...
            location: {
                center: [121.7584, 31.2245],//Shanghai
                zoom: 8,
                pitch: 50.00,
                bearing: 0
            },
        ...
        },
        {
            ...
            location: {
                center: [115.3269, 35.7621],//Puyang
                zoom: 9,
                pitch: 48.50,
                bearing: 0
            },
        ...
        },
        {
            ...
            location: {
                center: [104.0338, 1.3903],//Singapore
                zoom: 10,
                pitch: 48.50,
                bearing: 0
            },
        ...
        },
        {
            ...
            location: {
                center: [151.1050, -33.8570],//Sydeny
                zoom: 7,
                pitch: 34.50,
                bearing: 0
            },
